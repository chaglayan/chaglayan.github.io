...
interface USDWithdrawScreenProps {
  onBack: () => void;
}

export const USDWithdrawScreen: React.FC<USDWithdrawScreenProps> = ({ onBack }) => {
  const { usdBalance, updateUsdBalance, addTransaction, updateTransaction, addNotification } = useApp();
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: `Withdrawing $${withdrawAmount.toFixed(2)} from your account...`,
      });
    ...
    return (
      <div className="ios-container min-h-screen flex flex-col bg-white">
        <div className="ios-navbar flex items-center">
          ...
          <h1 className="flex-1 text-center font-semibold text-lg">Confirm Withdrawal</h1>
        ...
        <div className="flex-1 p-6">
          <div className="ios-card mb-6">
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-2">You're withdrawing</p>
          ...
          <div className="ios-card bg-blue-50 border border-blue-200 mt-4">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Funds will be transferred to your linked bank account. In a real app, this typically takes 3-5 business days.
            </p>
          </div>
        </div>
  ...
  return (
    <div className="ios-container min-h-screen flex flex-col bg-white">
      <div className="ios-navbar flex items-center">
        ...
        <h1 className="flex-1 text-center font-semibold text-lg">Withdraw USD</h1>
        <div className="w-16"></div>
      </div>

      <div className="flex-1 p-6">
        <div className="mb-6">
          <h2 className="text-2xl font-bold mb-2">How much would you like to withdraw?</h2>
          <p className="text-gray-600">Available: {formatCurrency(usdBalance)}</p>
        </div>
        ...
        <div className="ios-card bg-gray-50">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[50, 100, 250, 500, 1000].filter(amt => amt <= usdBalance).map(amt => (
              <button
                key={amt}
        ...
        <div className="ios-card mt-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Chase Bank •••• 4532</p>
              <p className="text-sm text-gray-500">No fees • 3-5 business days</p>
            </div>
          </div>
        </div>
      </div>
